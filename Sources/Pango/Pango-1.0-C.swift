...
public extension ContextProtocol {
    ...
    /// suitable font map.
    @inlinable func set(fontMap: FontMapRef? = nil) {
    ...
    @inlinable func set(language: LanguageRef? = nil) {
...
public extension CoverageProtocol {
    ...
    @available(*, deprecated) @discardableResult @inlinable func ref() -> CoverageRef! {
