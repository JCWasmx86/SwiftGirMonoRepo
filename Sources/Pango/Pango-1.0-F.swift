...
public extension FontRef {
    ...
    @inlinable static func deserialize<ContextT: ContextProtocol, GLibBytesT: GLib.BytesProtocol>(context: ContextT, bytes: GLibBytesT) throws -> FontRef! {
...
open class Font: GLibObject.Object, FontProtocol {
    ...
    /// the one that was serialized, you can compare `bytes` to the
    /// result of serializing the font again.
    @inlinable public static func deserialize<ContextT: ContextProtocol, GLibBytesT: GLib.BytesProtocol>(context: ContextT, bytes: GLibBytesT) throws -> Font! {
            var error: UnsafeMutablePointer<GError>?
        let result = pango_font_deserialize(context.context_ptr, bytes.bytes_ptr, &error)
        if let error = error { throw GLibError(error) }
...
///
public protocol FontFamilyProtocol: GLibObject.ObjectProtocol, GIO.ListModelProtocol {
...
public enum FontFamilyPropertyName: String, PropertyNameProtocol {
...
public extension FontFamilyProtocol {
    /// Bind a `FontFamilyPropertyName` source property to a given target object.
    ...
    @discardableResult @inlinable func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: FontFamilyPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
    ...
    /// Get the value of a FontFamily property
    /// - Parameter property: the property to get the value for
    /// - Returns: the value of the named property
    @inlinable func get(property: FontFamilyPropertyName) -> GLibObject.Value {
        let v = GLibObject.Value()
        g_object_get_property(ptr.assumingMemoryBound(to: GObject.self), property.rawValue, v.value_ptr)
        return v
    }

    /// Set the value of a FontFamily property.
    /// *Note* that this will only have an effect on properties that are writable and not construct-only!
    /// - Parameter property: the property to get the value for
    /// - Returns: the value of the named property
    @inlinable func set(property: FontFamilyPropertyName, value v: GLibObject.Value) {
...
///
public protocol FontMapProtocol: GLibObject.ObjectProtocol, GIO.ListModelProtocol {
