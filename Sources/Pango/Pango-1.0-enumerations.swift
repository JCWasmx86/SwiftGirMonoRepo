...
public extension BaselineShift {
    ...
    static let `none` = PANGO_BASELINE_SHIFT_NONE // 0
...
public extension FontScale {
    ...
    static let `none` = PANGO_FONT_SCALE_NONE // 0
...
public extension Overline {
    ...
    static let `none` = PANGO_OVERLINE_NONE // 0
...
public extension TextTransform {
    ...
    static let `none` = PANGO_TEXT_TRANSFORM_NONE // 0
