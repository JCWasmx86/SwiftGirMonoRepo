...
public extension MatrixProtocol {
    ...
    @inlinable func copy() -> MatrixRef! {
        let result = pango_matrix_copy(matrix_ptr)
    ...
    @inlinable func getFontScaleFactor() -> CDouble {
        let result = pango_matrix_get_font_scale_factor(matrix_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getSlantRatio() -> CDouble {
        let result = pango_matrix_get_slant_ratio(matrix_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func gravityGetForMatrix() -> PangoGravity {
        let result = pango_gravity_get_for_matrix(matrix_ptr)
        let rv = result
        return rv
    }
    /// Returns the scale factor of a matrix on the height of the font.
    ...
    /// 
    /// this is simply λ.
    @inlinable var slantRatio: CDouble {
        /// Gets the slant ratio of a matrix.
        /// 
        /// For a simple shear matrix in the form:
        /// 
