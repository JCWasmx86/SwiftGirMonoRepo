...
public struct FrameClockPhase: OptionSet {
    ...
    /// no phase
    public static let `none` = FrameClockPhase(0)
...
public struct GLAPI: OptionSet {
    ...
    /// The equivalent raw `gint` value
    @inlinable public var int: gint { get { gint(rawValue) } set { rawValue = UInt32(newValue) } }
    /// The equivalent underlying `GdkGLAPI` enum value
    @inlinable public var value: GdkGLAPI {
        get {
            func castToGdkGLAPIInt<I: BinaryInteger, J: BinaryInteger>(_ param: I) -> J { J(param) }
            return GdkGLAPI(rawValue: castToGdkGLAPIInt(rawValue))
        }
        set { rawValue = UInt32(newValue.rawValue) }
    }
    ...
    /// Creates a new instance with the specified raw value
    @inlinable public init(rawValue: UInt32) { self.rawValue = rawValue }
    /// Creates a new instance with the specified `GdkGLAPI` enum value
    @inlinable public init(_ enumValue: GdkGLAPI) { self.rawValue = UInt32(enumValue.rawValue) }
    /// Creates a new instance with the specified Int value
    @inlinable public init<I: BinaryInteger>(_ intValue: I) { self.rawValue = UInt32(intValue)  }

    /// The OpenGL API
    public static let gl = GLAPI(1) // GDK_GL_API_GL

    /// The OpenGL ES API
    public static let gles = GLAPI(2) // GDK_GL_API_GLES
...
public struct SeatCapabilities: OptionSet {
    ...
    public static let `none` = SeatCapabilities(0)
