...
public extension EventType {
    ...
    static let touchpadHold = GDK_TOUCHPAD_HOLD // 28

    /// marks the end of the GdkEventType enumeration.
    static let eventLast = GDK_EVENT_LAST // 29
...
public extension MemoryFormat {
    ...
    static let r16g16b16 = GDK_MEMORY_R16G16B16 // 9

    /// 4 guint16 values; for red, green,
    ///   blue, alpha. The color values are premultiplied with the alpha value.
    ///  Since: 4.6
    static let r16g16b16a16Premultiplied = GDK_MEMORY_R16G16B16A16_PREMULTIPLIED // 10

    /// 4 guint16 values; for red, green, blue, alpha.
    ///  Since: 4.6
    static let r16g16b16a16 = GDK_MEMORY_R16G16B16A16 // 11

    /// 3 half-float values; for red, green, blue.
    ///   The data is opaque. Since: 4.6
    static let r16g16b16Float = GDK_MEMORY_R16G16B16_FLOAT // 12

    /// 4 half-float values; for
    ///   red, green, blue and alpha. The color values are premultiplied with
    ///   the alpha value. Since: 4.6
    static let r16g16b16a16FloatPremultiplied = GDK_MEMORY_R16G16B16A16_FLOAT_PREMULTIPLIED // 13

    /// 4 half-float values; for red, green,
    ///   blue and alpha. Since: 4.6
    static let r16g16b16a16Float = GDK_MEMORY_R16G16B16A16_FLOAT // 14

    static let r32g32b32Float = GDK_MEMORY_R32G32B32_FLOAT // 15

    /// 4 float values; for
    ///   red, green, blue and alpha. The color values are premultiplied with
    ///   the alpha value. Since: 4.6
    static let r32g32b32a32FloatPremultiplied = GDK_MEMORY_R32G32B32A32_FLOAT_PREMULTIPLIED // 16

    /// 4 float values; for red, green, blue and
    ///   alpha. Since: 4.6
    static let r32g32b32a32Float = GDK_MEMORY_R32G32B32A32_FLOAT // 17

    /// The number of formats. This value will change as
    ///   more formats get added, so do not rely on its concrete integer.
    static let nFormats = GDK_MEMORY_N_FORMATS // 18
...
public typealias ScrollUnit = GdkScrollUnit


public extension ScrollUnit {
    /// Cast constructor, converting any binary integer to a
    /// `ScrollUnit`.
    /// - Parameter raw: The raw integer value to initialise the enum from
    @inlinable init!<I: BinaryInteger>(_ raw: I) {
        func castToScrollUnitInt<I: BinaryInteger, J: BinaryInteger>(_ param: I) -> J { J(param) }
        self.init(rawValue: castToScrollUnitInt(raw))
    }
    /// The delta is in number of wheel clicks.
    static let wheel = GDK_SCROLL_UNIT_WHEEL // 0

    /// The delta is in surface pixels to scroll directly
    ///   on screen.
    static let surface = GDK_SCROLL_UNIT_SURFACE // 1
...
public typealias TextureError = GdkTextureError
...
public extension TextureError {
    ...
    static let tooLarge = GDK_TEXTURE_ERROR_TOO_LARGE // 0

    /// The image data appears corrupted
    static let corruptImage = GDK_TEXTURE_ERROR_CORRUPT_IMAGE // 1

    /// The image contains features
    ///   that cannot be loaded
    static let unsupportedContent = GDK_TEXTURE_ERROR_UNSUPPORTED_CONTENT // 2

    /// The image format is not supported
    static let unsupportedFormat = GDK_TEXTURE_ERROR_UNSUPPORTED_FORMAT // 3

}



public typealias TitlebarGesture = GdkTitlebarGesture


public extension TitlebarGesture {
    /// Cast constructor, converting any binary integer to a
    /// `TitlebarGesture`.
    /// - Parameter raw: The raw integer value to initialise the enum from
    @inlinable init!<I: BinaryInteger>(_ raw: I) {
        func castToTitlebarGestureInt<I: BinaryInteger, J: BinaryInteger>(_ param: I) -> J { J(param) }
        self.init(rawValue: castToTitlebarGestureInt(raw))
    }
    static let doubleClick = GDK_TITLEBAR_GESTURE_DOUBLE_CLICK // 1

    static let rightClick = GDK_TITLEBAR_GESTURE_RIGHT_CLICK // 2

    static let middleClick = GDK_TITLEBAR_GESTURE_MIDDLE_CLICK // 3
