...
public extension ParamSpecClassProtocol {
    ...
    // var valueIsValid is unavailable because value_is_valid is void
...
public extension ParamSpecRef {
    ...
    @inlinable static func internal_(paramType: GType, name: UnsafePointer<gchar>!, nick: UnsafePointer<gchar>? = nil, blurb: UnsafePointer<gchar>? = nil, flags: ParamFlags) -> GLibObject.ParamSpecRef! {
...
open class ParamSpec: ParamSpecProtocol {
    ...
    /// are essential. When in doubt, follow the conventions used in the
    /// surrounding code and supporting libraries.
    @inlinable public static func internal_(paramType: GType, name: UnsafePointer<gchar>!, nick: UnsafePointer<gchar>? = nil, blurb: UnsafePointer<gchar>? = nil, flags: ParamFlags) -> GLibObject.ParamSpec! {
            let result = g_param_spec_internal(paramType, name, nick, blurb, flags.value)
...
public extension ParamSpecProtocol {
    ...
    @inlinable func paramSpecValueArray(name: UnsafePointer<gchar>!, nick: UnsafePointer<gchar>? = nil, blurb: UnsafePointer<gchar>? = nil, flags: ParamFlags) -> GLibObject.ParamSpecRef! {
    ...
    /// set out by `pspec`.
    @inlinable func paramValueIsValid<ValueT: ValueProtocol>(value: ValueT) -> Bool {
        let result = g_param_value_is_valid(param_spec_ptr, value.value_ptr)
        let rv = ((result) != 0)
        return rv
    }
