...
public extension UnicodeScript {
    ...
    static let cyproMinoan = G_UNICODE_SCRIPT_CYPRO_MINOAN // 157

    /// Old Uyghur. Since: 2.72
    static let oldUyghur = G_UNICODE_SCRIPT_OLD_UYGHUR // 158

    /// Tangsa. Since: 2.72
    static let tangsa = G_UNICODE_SCRIPT_TANGSA // 159

    /// Toto. Since: 2.72
    static let toto = G_UNICODE_SCRIPT_TOTO // 160

    /// Vithkuqi. Since: 2.72
    static let vithkuqi = G_UNICODE_SCRIPT_VITHKUQI // 161

    /// Mathematical notation. Since: 2.72
    static let math = G_UNICODE_SCRIPT_MATH // 162
