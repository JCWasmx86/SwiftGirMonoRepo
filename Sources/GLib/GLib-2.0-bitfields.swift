...
public struct FormatSizeFlags: OptionSet {
    ...
    public static let onlyValue = FormatSizeFlags(8) // G_FORMAT_SIZE_ONLY_VALUE

    /// return only unit, without value; this should
    ///     not be used together with `G_FORMAT_SIZE_LONG_FORMAT`
    ///     nor `G_FORMAT_SIZE_ONLY_VALUE`. Since: 2.74
    public static let onlyUnit = FormatSizeFlags(16) // G_FORMAT_SIZE_ONLY_UNIT
...
public struct IOFlags: OptionSet {
    ...
    public static let `none` = IOFlags(0)
...
/// of a `GMainContext`.
public struct MainContextFlags: OptionSet {
    /// The corresponding value of the raw type
    public var rawValue: UInt32 = 0
    /// The equivalent raw Int value
    @inlinable public var intValue: Int { get { Int(rawValue) } set { rawValue = UInt32(newValue) } }
    /// The equivalent raw `gint` value
    @inlinable public var int: gint { get { gint(rawValue) } set { rawValue = UInt32(newValue) } }
    /// The equivalent underlying `GMainContextFlags` enum value
    @inlinable public var value: GMainContextFlags {
        get {
            func castToGMainContextFlagsInt<I: BinaryInteger, J: BinaryInteger>(_ param: I) -> J { J(param) }
            return GMainContextFlags(rawValue: castToGMainContextFlagsInt(rawValue))
        }
        set { rawValue = UInt32(newValue.rawValue) }
    }
    ...
    /// Creates a new instance with the specified raw value
    @inlinable public init(rawValue: UInt32) { self.rawValue = rawValue }
    /// Creates a new instance with the specified `GMainContextFlags` enum value
    @inlinable public init(_ enumValue: GMainContextFlags) { self.rawValue = UInt32(enumValue.rawValue) }
    /// Creates a new instance with the specified Int value
    @inlinable public init<I: BinaryInteger>(_ intValue: I) { self.rawValue = UInt32(intValue)  }

    /// Default behaviour.
    public static let `none` = MainContextFlags(0)

    /// Assume that polling for events will
    /// free the thread to process other jobs. That's useful if you're using
    /// `g_main_context_{prepare,query,check,dispatch}` to integrate GMainContext in
    /// other event loops.
    public static let ownerlessPolling = MainContextFlags(1) // G_MAIN_CONTEXT_FLAGS_OWNERLESS_POLLING
...
public struct MarkupParseFlags: OptionSet {
    ...
    public static let defaultFlags = MarkupParseFlags(0) // G_MARKUP_DEFAULT_FLAGS
...
public struct RegexCompileFlags: OptionSet {
    ...
    public static let `default` = RegexCompileFlags(0) // G_REGEX_DEFAULT
...
public struct RegexMatchFlags: OptionSet {
    ...
    /// No special options set. Since: 2.74
    public static let `default` = RegexMatchFlags(0) // G_REGEX_MATCH_DEFAULT
...
public struct SpawnFlags: OptionSet {
    ...
    public static let childInheritsStdout = SpawnFlags(512) // G_SPAWN_CHILD_INHERITS_STDOUT

    /// The child will inherit the parent's standard error.
    public static let childInheritsStderr = SpawnFlags(1024) // G_SPAWN_CHILD_INHERITS_STDERR

    /// The child's standard input is attached to `/dev/null`.
    public static let stdinFromDevNull = SpawnFlags(2048) // G_SPAWN_STDIN_FROM_DEV_NULL
...
public struct TestSubprocessFlags: OptionSet {
    ...
    public static let `default` = TestSubprocessFlags(0) // G_TEST_SUBPROCESS_DEFAULT

    /// If this flag is given, the child
    ///     process will inherit the parent's stdin. Otherwise, the child's
    ///     stdin is redirected to `/dev/null`.
    public static let inheritStdin = TestSubprocessFlags(1) // G_TEST_SUBPROCESS_INHERIT_STDIN

    /// If this flag is given, the child
    ///     process will inherit the parent's stdout. Otherwise, the child's
    ///     stdout will not be visible, but it will be captured to allow
    ///     later tests with `g_test_trap_assert_stdout()`.
    public static let inheritStdout = TestSubprocessFlags(2) // G_TEST_SUBPROCESS_INHERIT_STDOUT

    /// If this flag is given, the child
    ///     process will inherit the parent's stderr. Otherwise, the child's
    ///     stderr will not be visible, but it will be captured to allow
    ///     later tests with `g_test_trap_assert_stderr()`.
    public static let inheritStderr = TestSubprocessFlags(4) // G_TEST_SUBPROCESS_INHERIT_STDERR
...
public struct TestTrapFlags: OptionSet {
    ...
    /// Default behaviour. Since: 2.74
    public static let `default` = TestTrapFlags(0) // G_TEST_TRAP_DEFAULT
