...
public extension MapListModelRef {
    ...
    @inlinable init<GioListModelT: GIO.ListModelProtocol>( model: GioListModelT?, mapFunc: GtkMapListModelMapFunc? = nil, userData: gpointer? = nil, userDestroy: GDestroyNotify?) {
            let result = gtk_map_list_model_new(model?.list_model_ptr, mapFunc, userData, userDestroy)
        let rv = result
...
open class MapListModel: GLibObject.Object, MapListModelProtocol {
    ...
    /// Creates a new `GtkMapListModel` for the given arguments.
    @inlinable public init<GioListModelT: GIO.ListModelProtocol>( model: GioListModelT?, mapFunc: GtkMapListModelMapFunc? = nil, userData: gpointer? = nil, userDestroy: GDestroyNotify?) {
            let result = gtk_map_list_model_new(model?.list_model_ptr, mapFunc, userData, userDestroy)
        let rv = result
...
public extension MapListModelProtocol {
    ...
    @inlinable func getModel() -> GIO.ListModelRef! {
        let result = gtk_map_list_model_get_model(map_list_model_ptr)
    ...
    @inlinable func hasMap() -> Bool {
        let result = gtk_map_list_model_has_map(map_list_model_ptr)
        let rv = ((result) != 0)
        return rv
    }
...
public extension MediaControlsRef {
    ...
    @inlinable init<MediaStreamT: MediaStreamProtocol>( stream: MediaStreamT?) {
            let result = gtk_media_controls_new(stream?.media_stream_ptr)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
}
...
public extension MediaControlsProtocol {
    ...
    @inlinable func getMediaStream() -> MediaStreamRef! {
        let result = gtk_media_controls_get_media_stream(media_controls_ptr)
...
public extension MediaFileProtocol {
    ...
    @inlinable func getFile() -> GIO.FileRef! {
        let result = gtk_media_file_get_file(media_file_ptr)
    ...
    @inlinable func getInputStream() -> GIO.InputStreamRef! {
        let result = gtk_media_file_get_input_stream(media_file_ptr)
    ...
    /// Full control about the `stream` is assumed for the duration of
    /// playback. The stream will not be closed.
    @inlinable func setInput<GioInputStreamT: GIO.InputStreamProtocol>(stream: GioInputStreamT?) {
...
public extension MediaStreamProtocol {
    ...
    /// [method`Gtk.MediaStream.unprepared`].
    @inlinable func gerror<GLibGLibErrorT: GLib.ErrorProtocol>(error: GLibGLibErrorT) {
    ...
    @inlinable func getDuration() -> gint64 {
        let result = gtk_media_stream_get_duration(media_stream_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getEnded() -> Bool {
        let result = gtk_media_stream_get_ended(media_stream_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getError() -> GLib.ErrorRef! {
        let result = gtk_media_stream_get_error(media_stream_ptr)
    ...
    @inlinable func getLoop() -> Bool {
        let result = gtk_media_stream_get_loop(media_stream_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getMuted() -> Bool {
        let result = gtk_media_stream_get_muted(media_stream_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getPlaying() -> Bool {
        let result = gtk_media_stream_get_playing(media_stream_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getTimestamp() -> gint64 {
        let result = gtk_media_stream_get_timestamp(media_stream_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getVolume() -> CDouble {
        let result = gtk_media_stream_get_volume(media_stream_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func hasAudio() -> Bool {
        let result = gtk_media_stream_has_audio(media_stream_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func hasVideo() -> Bool {
        let result = gtk_media_stream_has_video(media_stream_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func realize<GdkSurfaceT: Gdk.SurfaceProtocol>(surface: GdkSurfaceT) {
    ...
    @inlinable func unrealize<GdkSurfaceT: Gdk.SurfaceProtocol>(surface: GdkSurfaceT) {
    ...
    @inlinable var isPrepared: Bool {
        ...
        /// At this point the existence of audio and video is known.
        get {
            let result = gtk_media_stream_is_prepared(media_stream_ptr)
        let rv = ((result) != 0)
            return rv
        }
    }
    ...
    @inlinable var isSeekable: Bool {
        ...
        /// stream, though it will not do anything.
        get {
            let result = gtk_media_stream_is_seekable(media_stream_ptr)
        let rv = ((result) != 0)
            return rv
        }
    }
    ...
    @inlinable var isSeeking: Bool {
        /// Checks if there is currently a seek operation going on.
        get {
            let result = gtk_media_stream_is_seeking(media_stream_ptr)
        let rv = ((result) != 0)
            return rv
        }
    }
...
public extension MenuButtonRef {
    ...
    /// should you wish to.
    @inlinable init() {
            let result = gtk_menu_button_new()
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
}
...
public extension MenuButtonProtocol {
    ...
    @discardableResult @inlinable func onNotifyAlwaysShowArrow(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(MenuButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((MenuButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
            return output
        }
        return connect(
    ...
    @discardableResult @inlinable func onNotifyChild(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(MenuButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((MenuButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    static var notifyChildSignal: MenuButtonSignalName { .notifyChild }
    ...
    @discardableResult @inlinable func onNotifyDirection(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(MenuButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((MenuButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyHasFrame(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(MenuButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((MenuButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyIconName(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(MenuButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((MenuButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyLabel(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(MenuButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((MenuButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyMenuModel(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(MenuButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((MenuButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyPopover(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(MenuButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((MenuButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyPrimary(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(MenuButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((MenuButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyUseUnderline(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: MenuButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(MenuButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((MenuButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
...
public extension MenuButtonProtocol {
    ...
    @inlinable func getAlwaysShowArrow() -> Bool {
        let result = gtk_menu_button_get_always_show_arrow(menu_button_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getChild() -> WidgetRef! {
        let result = gtk_menu_button_get_child(menu_button_ptr)
    ...
    @inlinable func getDirection() -> GtkArrowType {
        let result = gtk_menu_button_get_direction(menu_button_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getHasFrame() -> Bool {
        let result = gtk_menu_button_get_has_frame(menu_button_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getIconName() -> String! {
        let result = gtk_menu_button_get_icon_name(menu_button_ptr)
    ...
    @inlinable func getLabel() -> String! {
        let result = gtk_menu_button_get_label(menu_button_ptr)
        let rv = result.map({ String(cString: $0) })
        return rv
    }
    ...
    @inlinable func getMenuModel() -> GIO.MenuModelRef! {
        let result = gtk_menu_button_get_menu_model(menu_button_ptr)
    ...
    @inlinable func getPopover() -> PopoverRef! {
        let result = gtk_menu_button_get_popover(menu_button_ptr)
        let rv = PopoverRef(gconstpointer: gconstpointer(result))
        return rv
    }

    /// Returns whether the menu button acts as a primary menu.
    @inlinable func getPrimary() -> Bool {
        let result = gtk_menu_button_get_primary(menu_button_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getUseUnderline() -> Bool {
        let result = gtk_menu_button_get_use_underline(menu_button_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func set(child: WidgetRef? = nil) {
        ...
        gtk_menu_button_set_child(menu_button_ptr, child?.widget_ptr)
    ...
    @inlinable var child: WidgetRef! {
        ...
        /// will be shown next to the child.
        nonmutating set {
            gtk_menu_button_set_child(menu_button_ptr, UnsafeMutablePointer<GtkWidget>(newValue?.widget_ptr))
        }
    }
...
public extension MessageDialogProtocol {
    ...
    @inlinable func getMessageArea() -> WidgetRef! {
        let result = gtk_message_dialog_get_message_area(message_dialog_ptr)
        guard let rv = WidgetRef(gconstpointer: gconstpointer(result)) else { return nil }
        return rv
    }
...
public extension MnemonicTriggerProtocol {
    ...
    @inlinable func getKeyval() -> Int {
        let result = gtk_mnemonic_trigger_get_keyval(mnemonic_trigger_ptr)
        let rv = Int(result)
        return rv
    }
    /// The key value for the trigger.
...
public extension MountOperationRef {
    ...
    @inlinable init<WindowT: WindowProtocol>( parent: WindowT?) {
            let result = gtk_mount_operation_new(parent?.window_ptr)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
}
...
open class MountOperation: GIO.MountOperation, MountOperationProtocol {
    ...
    /// Creates a new `GtkMountOperation`.
    @inlinable public init<WindowT: WindowProtocol>( parent: WindowT?) {
            let result = gtk_mount_operation_new(parent?.window_ptr)
        let rv = result
            super.init(gpointer: gpointer(rv))
    if typeIsA(type: self.type, isAType: InitiallyUnownedClassRef.metatypeReference) { _ = self.refSink() } 
...
public extension MountOperationProtocol {
    ...
    @inlinable func getDisplay() -> Gdk.DisplayRef! {
        let result = gtk_mount_operation_get_display(mount_operation_ptr)
    ...
    @inlinable func getParent() -> WindowRef! {
        let result = gtk_mount_operation_get_parent(mount_operation_ptr)
    ...
    @inlinable var isShowing: Bool {
        ...
        /// a window.
        get {
            let result = gtk_mount_operation_is_showing(mount_operation_ptr)
        let rv = ((result) != 0)
            return rv
        }
    }
...
public enum MultiFilterPropertyName: String, PropertyNameProtocol {
    /// The type of items. See [method`Gio.ListModel.get_item_type`].
    case itemType = "item-type"
    /// The number of items. See [method`Gio.ListModel.get_n_items`].
    case nItems = "n-items"
...
public extension MultiFilterProtocol {
    /// Bind a `MultiFilterPropertyName` source property to a given target object.
    /// - Parameter source_property: the source property to bind
    /// - Parameter target: the target object to bind to
    /// - Parameter target_property: the target property to bind to
    /// - Parameter flags: the flags to pass to the `Binding`
    ...
    /// - Parameter transform_to: `ValueTransformer` to use for backwards transformation
    /// - Returns: binding reference or `nil` in case of an error
    @discardableResult @inlinable func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MultiFilterPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(holder).toOpaque())
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
    ...
    /// Get the value of a MultiFilter property
    /// - Parameter property: the property to get the value for
    /// - Returns: the value of the named property
    @inlinable func get(property: MultiFilterPropertyName) -> GLibObject.Value {
        let v = GLibObject.Value()
        g_object_get_property(ptr.assumingMemoryBound(to: GObject.self), property.rawValue, v.value_ptr)
        return v
    }

    /// Set the value of a MultiFilter property.
    /// *Note* that this will only have an effect on properties that are writable and not construct-only!
    /// - Parameter property: the property to get the value for
    /// - Returns: the value of the named property
    @inlinable func set(property: MultiFilterPropertyName, value v: GLibObject.Value) {
        g_object_set_property(ptr.assumingMemoryBound(to: GObject.self), property.rawValue, v.value_ptr)
    }
}
...
public extension MultiSelectionRef {
    ...
    @inlinable init<GioListModelT: GIO.ListModelProtocol>( model: GioListModelT?) {
            let result = gtk_multi_selection_new(model?.list_model_ptr)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
}
...
public extension MultiSelectionProtocol {
    ...
    @inlinable func getModel() -> GIO.ListModelRef! {
        let result = gtk_multi_selection_get_model(multi_selection_ptr)
        let rv = GIO.ListModelRef(gconstpointer: gconstpointer(result))
        return rv
    }
...
public extension MultiSorterRef {
    ...
    /// items as equal.
    @inlinable init() {
            let result = gtk_multi_sorter_new()
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
}
...
public enum MultiSorterPropertyName: String, PropertyNameProtocol {
    /// The type of items. See [method`Gio.ListModel.get_item_type`].
    case itemType = "item-type"
    /// The number of items. See [method`Gio.ListModel.get_n_items`].
    case nItems = "n-items"
...
public extension MultiSorterProtocol {
    /// Bind a `MultiSorterPropertyName` source property to a given target object.
    /// - Parameter source_property: the source property to bind
    /// - Parameter target: the target object to bind to
    /// - Parameter target_property: the target property to bind to
    /// - Parameter flags: the flags to pass to the `Binding`
    ...
    /// - Parameter transform_to: `ValueTransformer` to use for backwards transformation
    /// - Returns: binding reference or `nil` in case of an error
    @discardableResult @inlinable func bind<Q: PropertyNameProtocol, T: GLibObject.ObjectProtocol>(property source_property: MultiSorterPropertyName, to target: T, _ target_property: Q, flags f: BindingFlags = .default, transformFrom transform_from: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }, transformTo transform_to: @escaping GLibObject.ValueTransformer = { $0.transform(destValue: $1) }) -> BindingRef! {
        func _bind(_ source: UnsafePointer<gchar>, to t: T, _ target_property: UnsafePointer<gchar>, flags f: BindingFlags = .default, holder: BindingClosureHolder, transformFrom transform_from: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean, transformTo transform_to: @convention(c) @escaping (gpointer, gpointer, gpointer, gpointer) -> gboolean) -> BindingRef! {
            let holder = UnsafeMutableRawPointer(Unmanaged.passRetained(holder).toOpaque())
            let from = unsafeBitCast(transform_from, to: BindingTransformFunc.self)
            let to   = unsafeBitCast(transform_to,   to: BindingTransformFunc.self)
    ...
    /// Get the value of a MultiSorter property
    /// - Parameter property: the property to get the value for
    /// - Returns: the value of the named property
    @inlinable func get(property: MultiSorterPropertyName) -> GLibObject.Value {
        let v = GLibObject.Value()
        g_object_get_property(ptr.assumingMemoryBound(to: GObject.self), property.rawValue, v.value_ptr)
        return v
    }

    /// Set the value of a MultiSorter property.
    /// *Note* that this will only have an effect on properties that are writable and not construct-only!
    /// - Parameter property: the property to get the value for
    /// - Returns: the value of the named property
    @inlinable func set(property: MultiSorterPropertyName, value v: GLibObject.Value) {
        g_object_set_property(ptr.assumingMemoryBound(to: GObject.self), property.rawValue, v.value_ptr)
    }
}
