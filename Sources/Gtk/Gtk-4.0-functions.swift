...
@inlinable public func acceleratorGetDefaultModMask() -> Gdk.ModifierType {
    let result = gtk_accelerator_get_default_mod_mask()
...
@inlinable public func acceleratorGetLabel(acceleratorKey: Int, acceleratorMods: Gdk.ModifierType) -> String! {
    let result = gtk_accelerator_get_label(guint(acceleratorKey), acceleratorMods.value)
...
@inlinable public func acceleratorGetLabelWithKeycode(display: Gdk.DisplayRef? = nil, acceleratorKey: Int, keycode: Int, acceleratorMods: Gdk.ModifierType) -> String! {
    let result = gtk_accelerator_get_label_with_keycode(display?.display_ptr, guint(acceleratorKey), guint(keycode), acceleratorMods.value)
    guard let rv = result.map({ String(cString: $0) }) else { return nil }
    return rv
}
/// Converts an accelerator keyval and modifier mask
...
/// components, applications should use [func`Gtk.accelerator_get_label`]
/// instead.
@inlinable public func acceleratorGetLabelWithKeycode<GdkDisplayT: Gdk.DisplayProtocol>(display: GdkDisplayT?, acceleratorKey: Int, keycode: Int, acceleratorMods: Gdk.ModifierType) -> String! {
    let result = gtk_accelerator_get_label_with_keycode(display?.display_ptr, guint(acceleratorKey), guint(keycode), acceleratorMods.value)
    guard let rv = result.map({ String(cString: $0) }) else { return nil }
    return rv
}
...
@inlinable public func acceleratorName(acceleratorKey: Int, acceleratorMods: Gdk.ModifierType) -> String! {
    let result = gtk_accelerator_name(guint(acceleratorKey), acceleratorMods.value)
    guard let rv = result.map({ String(cString: $0) }) else { return nil }
    return rv
}
...
@inlinable public func acceleratorNameWithKeycode(display: Gdk.DisplayRef? = nil, acceleratorKey: Int, keycode: Int, acceleratorMods: Gdk.ModifierType) -> String! {
    let result = gtk_accelerator_name_with_keycode(display?.display_ptr, guint(acceleratorKey), guint(keycode), acceleratorMods.value)
    guard let rv = result.map({ String(cString: $0) }) else { return nil }
    return rv
}
/// Converts an accelerator keyval and modifier mask
...
/// This is only useful for system-level components, applications
/// should use [func`Gtk.accelerator_name`] instead.
@inlinable public func acceleratorNameWithKeycode<GdkDisplayT: Gdk.DisplayProtocol>(display: GdkDisplayT?, acceleratorKey: Int, keycode: Int, acceleratorMods: Gdk.ModifierType) -> String! {
    let result = gtk_accelerator_name_with_keycode(display?.display_ptr, guint(acceleratorKey), guint(keycode), acceleratorMods.value)
    guard let rv = result.map({ String(cString: $0) }) else { return nil }
    return rv
}
...
@inlinable public func acceleratorParse(accelerator: UnsafePointer<CChar>!, acceleratorKey: UnsafeMutablePointer<guint>! = nil, acceleratorMods: UnsafeMutablePointer<GdkModifierType>! = nil) -> Bool {
    let result = gtk_accelerator_parse(accelerator, acceleratorKey, acceleratorMods)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func acceleratorParseWithKeycode(accelerator: UnsafePointer<CChar>!, display: Gdk.DisplayRef? = nil, acceleratorKey: UnsafeMutablePointer<guint>! = nil, acceleratorCodes: UnsafeMutablePointer<UnsafeMutablePointer<guint>?>! = nil, acceleratorMods: UnsafeMutablePointer<GdkModifierType>! = nil) -> Bool {
    let result = gtk_accelerator_parse_with_keycode(accelerator, display?.display_ptr, acceleratorKey, acceleratorCodes, acceleratorMods)
    let rv = ((result) != 0)
    return rv
}
/// Parses a string representing an accelerator.
...
/// If the parse fails, `accelerator_key`, `accelerator_mods` and
/// `accelerator_codes` will be set to 0 (zero).
@inlinable public func acceleratorParseWithKeycode<GdkDisplayT: Gdk.DisplayProtocol>(accelerator: UnsafePointer<CChar>!, display: GdkDisplayT?, acceleratorKey: UnsafeMutablePointer<guint>! = nil, acceleratorCodes: UnsafeMutablePointer<UnsafeMutablePointer<guint>?>! = nil, acceleratorMods: UnsafeMutablePointer<GdkModifierType>! = nil) -> Bool {
    let result = gtk_accelerator_parse_with_keycode(accelerator, display?.display_ptr, acceleratorKey, acceleratorCodes, acceleratorMods)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func acceleratorValid(keyval: Int, modifiers: Gdk.ModifierType) -> Bool {
    let result = gtk_accelerator_valid(guint(keyval), modifiers.value)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func accessiblePropertyInitValue<GObjectValueT: GLibObject.ValueProtocol>(property: GtkAccessibleProperty, value: GObjectValueT) {
...
@inlinable public func accessibleRelationInitValue<GObjectValueT: GLibObject.ValueProtocol>(relation: GtkAccessibleRelation, value: GObjectValueT) {
...
@inlinable public func accessibleStateInitValue<GObjectValueT: GLibObject.ValueProtocol>(state: GtkAccessibleState, value: GObjectValueT) {
...
@inlinable public func bitsetIterInitAt<BitsetIterT: BitsetIterProtocol, BitsetT: BitsetProtocol>(iter: BitsetIterT, set: BitsetT, target: Int, value: UnsafeMutablePointer<guint>! = nil) -> Bool {
    let result = gtk_bitset_iter_init_at(iter.bitset_iter_ptr, set.bitset_ptr, guint(target), value)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func bitsetIterInitFirst<BitsetIterT: BitsetIterProtocol, BitsetT: BitsetProtocol>(iter: BitsetIterT, set: BitsetT, value: UnsafeMutablePointer<guint>! = nil) -> Bool {
    let result = gtk_bitset_iter_init_first(iter.bitset_iter_ptr, set.bitset_ptr, value)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func bitsetIterInitLast<BitsetIterT: BitsetIterProtocol, BitsetT: BitsetProtocol>(iter: BitsetIterT, set: BitsetT, value: UnsafeMutablePointer<guint>! = nil) -> Bool {
    let result = gtk_bitset_iter_init_last(iter.bitset_iter_ptr, set.bitset_ptr, value)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func builderErrorQuark() -> GQuark {
    let result = gtk_builder_error_quark()
    let rv = result
    return rv
}
...
@inlinable public func constraintVflParserErrorQuark() -> GQuark {
    let result = gtk_constraint_vfl_parser_error_quark()
    let rv = result
    return rv
}
...
@inlinable public func cssParserErrorQuark() -> GQuark {
    let result = gtk_css_parser_error_quark()
    let rv = result
    return rv
}
...
@inlinable public func cssParserWarningQuark() -> GQuark {
    let result = gtk_css_parser_warning_quark()
    let rv = result
    return rv
}
...
@inlinable public func distributeNaturalAllocation(extraSpace: Int, nRequestedSizes: Int, sizes: UnsafeMutablePointer<GtkRequestedSize>!) -> Int {
    let result = gtk_distribute_natural_allocation(gint(extraSpace), guint(nRequestedSizes), sizes)
    let rv = Int(result)
    return rv
}
...
/// own properties.
@inlinable public func editableDelegateGetProperty<GObjectObjectT: GLibObject.ObjectProtocol, GObjectParamSpecT: GLibObject.ParamSpecProtocol, GObjectValueT: GLibObject.ValueProtocol>(object: GObjectObjectT, propId: Int, value: GObjectValueT, pspec: GObjectParamSpecT) -> Bool {
    let result = gtk_editable_delegate_get_property(object.object_ptr, guint(propId), value.value_ptr, pspec.param_spec_ptr)
    let rv = ((result) != 0)
    return rv
}
...
/// function of your `GtkEditable` implementation, before handling your
/// own properties.
@inlinable public func editableDelegateSetProperty<GObjectObjectT: GLibObject.ObjectProtocol, GObjectParamSpecT: GLibObject.ParamSpecProtocol, GObjectValueT: GLibObject.ValueProtocol>(object: GObjectObjectT, propId: Int, value: GObjectValueT, pspec: GObjectParamSpecT) -> Bool {
    let result = gtk_editable_delegate_set_property(object.object_ptr, guint(propId), value.value_ptr, pspec.param_spec_ptr)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func editableInstallProperties<GObjectObjectClassT: GLibObject.ObjectClassProtocol>(objectClass: GObjectObjectClassT, firstProp: Int) -> Int {
    let result = gtk_editable_install_properties(objectClass._ptr, guint(firstProp))
    let rv = Int(result)
    return rv
}
...
@inlinable public func fileChooserErrorQuark() -> GQuark {
    let result = gtk_file_chooser_error_quark()
    let rv = result
    return rv
}
...
@inlinable public func getDebugFlags() -> Gtk.DebugFlags {
    let result = gtk_get_debug_flags()
    let rv = DebugFlags(result)
    return rv
}
...
@inlinable public func getDefaultLanguage() -> Pango.LanguageRef! {
    let result = gtk_get_default_language()
    guard let rv = Pango.LanguageRef(gconstpointer: gconstpointer(result)) else { return nil }
    return rv
}
...
@inlinable public func getInterfaceAge() -> Int {
    let result = gtk_get_interface_age()
    let rv = Int(result)
    return rv
}
...
@inlinable public func getLocaleDirection() -> GtkTextDirection {
    let result = gtk_get_locale_direction()
    let rv = result
    return rv
}
...
@inlinable public func getMajorVersion() -> Int {
    let result = gtk_get_major_version()
    let rv = Int(result)
    return rv
}
...
@inlinable public func getMicroVersion() -> Int {
    let result = gtk_get_micro_version()
    let rv = Int(result)
    return rv
}
...
@inlinable public func getMinorVersion() -> Int {
    let result = gtk_get_minor_version()
    let rv = Int(result)
    return rv
}
...
@inlinable public func iconThemeErrorQuark() -> GQuark {
    let result = gtk_icon_theme_error_quark()
    let rv = result
    return rv
}
...
@inlinable public func nativeGetFor<GdkSurfaceT: Gdk.SurfaceProtocol>(surface: GdkSurfaceT) -> NativeRef! {
    let result = gtk_native_get_for_surface(surface.surface_ptr)
    guard let rv = NativeRef(gconstpointer: gconstpointer(result)) else { return nil }
    return rv
}
...
@inlinable public func orderingFromCmpfunc(cmpfuncResult: Int) -> GtkOrdering {
    let result = gtk_ordering_from_cmpfunc(gint(cmpfuncResult))
    let rv = result
    return rv
}
...
@inlinable public func paperSizeGetDefault() -> String! {
    let result = gtk_paper_size_get_default()
    guard let rv = result.map({ String(cString: $0) }) else { return nil }
    return rv
}
...
@inlinable public func paperSizeGetPaperSizes(includeCustom: Bool) -> GLib.ListRef! {
    let result = gtk_paper_size_get_paper_sizes(gboolean((includeCustom) ? 1 : 0))
...
@inlinable public func paramSpecExpression(name: UnsafePointer<CChar>!, nick: UnsafePointer<CChar>!, blurb: UnsafePointer<CChar>!, flags: GLibObject.ParamFlags) -> GLibObject.ParamSpecRef! {
    let result = gtk_param_spec_expression(name, nick, blurb, flags.value)
    guard let rv = GLibObject.ParamSpecRef(gconstpointer: gconstpointer(result)) else { return nil }
    return rv
}
...
@inlinable public func printErrorQuark() -> GQuark {
    let result = gtk_print_error_quark()
    let rv = result
    return rv
}
...
@inlinable public func printRunPageSetupDialog<PrintSettingsT: PrintSettingsProtocol>(parent: WindowRef? = nil, pageSetup: PageSetupRef? = nil, settings: PrintSettingsT) -> PageSetupRef! {
    let result = gtk_print_run_page_setup_dialog(parent?.window_ptr, pageSetup?.page_setup_ptr, settings.print_settings_ptr)
    guard let rv = PageSetupRef(gconstpointer: gconstpointer(result)) else { return nil }
    return rv
}
/// Runs a page setup dialog, letting the user modify the values from
/// `page_setup`. If the user cancels the dialog, the returned `GtkPageSetup`
...
@inlinable public func recentManagerErrorQuark() -> GQuark {
    let result = gtk_recent_manager_error_quark()
    let rv = result
    return rv
}
...
/// activity going on.
@inlinable public func renderActivity<StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, x: CDouble, y: CDouble, width: CDouble, height: CDouble) {
...
/// 
/// ![](arrows.png)
@inlinable public func renderArrow<StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, angle: CDouble, x: CDouble, y: CDouble, size: CDouble) {
...
/// 
/// ![](background.png)
@inlinable public func renderBackground<StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, x: CDouble, y: CDouble, width: CDouble, height: CDouble) {
...
/// 
/// ![](checks.png)
@inlinable public func renderCheck<StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, x: CDouble, y: CDouble, width: CDouble, height: CDouble) {
...
/// 
/// ![](expanders.png)
@inlinable public func renderExpander<StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, x: CDouble, y: CDouble, width: CDouble, height: CDouble) {
...
/// 
/// ![](focus.png)
@inlinable public func renderFocus<StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, x: CDouble, y: CDouble, width: CDouble, height: CDouble) {
...
/// 
/// ![](frames.png)
@inlinable public func renderFrame<StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, x: CDouble, y: CDouble, width: CDouble, height: CDouble) {
...
/// 
/// ![](handles.png)
@inlinable public func renderHandle<StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, x: CDouble, y: CDouble, width: CDouble, height: CDouble) {
...
@inlinable public func renderIcon<GdkTextureT: Gdk.TextureProtocol, StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, texture: GdkTextureT, x: CDouble, y: CDouble) {
...
@inlinable public func renderLayout<PangoLayoutT: Pango.LayoutProtocol, StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, x: CDouble, y: CDouble, layout: PangoLayoutT) {
...
@inlinable public func renderLine<StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, x0: CDouble, y0: CDouble, x1: CDouble, y1: CDouble) {
...
/// 
/// ![](options.png)
@inlinable public func renderOption<StyleContextT: StyleContextProtocol, cairoContextT: Cairo.ContextProtocol>(context: StyleContextT, cr: cairoContextT, x: CDouble, y: CDouble, width: CDouble, height: CDouble) {
...
/// This is the recommended call to be used as it passes information
/// necessary for sandbox helpers to parent their dialogs properly.
@inlinable public func showUriFull<GioCancellableT: GIO.CancellableProtocol, WindowT: WindowProtocol>(parent: WindowT?, uri: UnsafePointer<CChar>!, timestamp: guint32, cancellable: GioCancellableT?, callback: GAsyncReadyCallback? = nil, userData: gpointer? = nil) {
...
/// of the operation.
@inlinable public func showUriFullFinish<GIOAsyncResultT: GIO.AsyncResultProtocol, WindowT: WindowProtocol>(parent: WindowT, result: GIOAsyncResultT) throws -> Bool {
    var error: UnsafeMutablePointer<GError>?
    let result = gtk_show_uri_full_finish(parent.window_ptr, result.async_result_ptr, &error)
...
@inlinable public func testAccessibleHasProperty<AccessibleT: AccessibleProtocol>(accessible: AccessibleT, property: GtkAccessibleProperty) -> Bool {
    let result = gtk_test_accessible_has_property(accessible.accessible_ptr, property)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func testAccessibleHasRelation<AccessibleT: AccessibleProtocol>(accessible: AccessibleT, relation: GtkAccessibleRelation) -> Bool {
    let result = gtk_test_accessible_has_relation(accessible.accessible_ptr, relation)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func testAccessibleHasRole<AccessibleT: AccessibleProtocol>(accessible: AccessibleT, role: GtkAccessibleRole) -> Bool {
    let result = gtk_test_accessible_has_role(accessible.accessible_ptr, role)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func testAccessibleHasState<AccessibleT: AccessibleProtocol>(accessible: AccessibleT, state: GtkAccessibleState) -> Bool {
    let result = gtk_test_accessible_has_state(accessible.accessible_ptr, state)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func testListAllTypes(nTypes: UnsafeMutablePointer<guint>!) -> UnsafePointer<GType>! {
    let result = gtk_test_list_all_types(nTypes)
...
@inlinable public func treeCreateRowDragContent<TreeModelT: TreeModelProtocol, TreePathT: TreePathProtocol>(treeModel: TreeModelT, path: TreePathT) -> Gdk.ContentProviderRef! {
    let result = gtk_tree_create_row_drag_content(treeModel.tree_model_ptr, path.tree_path_ptr)
    guard let rv = Gdk.ContentProviderRef(gconstpointer: gconstpointer(result)) else { return nil }
    return rv
}
...
@inlinable public func treeGetRowDragData<GObjectValueT: GLibObject.ValueProtocol>(value: GObjectValueT, treeModel: UnsafeMutablePointer<UnsafeMutablePointer<GtkTreeModel>?>? = nil, path: UnsafeMutablePointer<UnsafeMutablePointer<GtkTreePath>?>? = nil) -> Bool {
    let result = gtk_tree_get_row_drag_data(value.value_ptr, treeModel, path)
    let rv = ((result) != 0)
    return rv
}
...
@inlinable public func treeRowReferenceDeleted<GObjectObjectT: GLibObject.ObjectProtocol, TreePathT: TreePathProtocol>(proxy: GObjectObjectT, path: TreePathT) {
...
@inlinable public func treeRowReferenceInserted<GObjectObjectT: GLibObject.ObjectProtocol, TreePathT: TreePathProtocol>(proxy: GObjectObjectT, path: TreePathT) {
...
@inlinable public func treeRowReferenceReordered<GObjectObjectT: GLibObject.ObjectProtocol, TreeIterT: TreeIterProtocol, TreePathT: TreePathProtocol>(proxy: GObjectObjectT, path: TreePathT, iter: TreeIterT, newOrder: UnsafeMutablePointer<CInt>!) {
...
/// a reference to it.
@inlinable public func valueDupExpression<GObjectValueT: GLibObject.ValueProtocol>(value: GObjectValueT) -> ExpressionRef! {
    let result = gtk_value_dup_expression(value.value_ptr)
...
@inlinable public func valueGetExpression<GObjectValueT: GLibObject.ValueProtocol>(value: GObjectValueT) -> ExpressionRef! {
    let result = gtk_value_get_expression(value.value_ptr)
    guard let rv = ExpressionRef(gconstpointer: gconstpointer(result)) else { return nil }
    return rv
}
...
@inlinable public func valueSetExpression<ExpressionT: ExpressionProtocol, GObjectValueT: GLibObject.ValueProtocol>(value: GObjectValueT, expression: ExpressionT) {
...
@inlinable public func valueTakeExpression<GObjectValueT: GLibObject.ValueProtocol>(value: GObjectValueT, expression: ExpressionRef? = nil) {
...
/// 
/// This function transfers the ownership of the `expression` to the `GValue`.
@inlinable public func valueTakeExpression<ExpressionT: ExpressionProtocol, GObjectValueT: GLibObject.ValueProtocol>(value: GObjectValueT, expression: ExpressionT?) {
