...
public struct DebugFlags: OptionSet {
    ...
    public static let invertTextDir = DebugFlags(524288) // GTK_DEBUG_INVERT_TEXT_DIR
...
public struct EventControllerScrollFlags: OptionSet {
    ...
    /// Don't emit scroll.
    public static let `none` = EventControllerScrollFlags(0)
...
public struct InputHints: OptionSet {
    ...
    public static let `none` = InputHints(0)
...
public struct StyleContextPrintFlags: OptionSet {
    ...
    /// Default value.
    public static let `none` = StyleContextPrintFlags(0)
