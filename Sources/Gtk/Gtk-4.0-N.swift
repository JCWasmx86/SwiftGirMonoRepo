...
public extension NativeRef {
    ...
    @inlinable static func getFor<GdkSurfaceT: Gdk.SurfaceProtocol>(surface: GdkSurfaceT) -> NativeRef! {
...
open class Native: Widget, NativeProtocol {
    ...
    /// Finds the `GtkNative` associated with the surface.
    @inlinable public static func getFor<GdkSurfaceT: Gdk.SurfaceProtocol>(surface: GdkSurfaceT) -> Native! {
            let result = gtk_native_get_for_surface(surface.surface_ptr)
        guard let rv = Native(gconstpointer: gconstpointer(result)) else { return nil }
...
public extension NativeProtocol {
    ...
    @inlinable func getRenderer() -> Gsk.RendererRef! {
        let result = gtk_native_get_renderer(native_ptr)
        let rv = Gsk.RendererRef(gconstpointer: gconstpointer(result))
        return rv
    }

    /// Returns the surface of this `GtkNative`.
    @inlinable func getSurface() -> Gdk.SurfaceRef! {
        let result = gtk_native_get_surface(native_ptr)
    ...
    /// Returns the renderer that is used for this `GtkNative`.
    @inlinable var renderer: Gsk.RendererRef! {
        /// Returns the renderer that is used for this `GtkNative`.
        get {
            let result = gtk_native_get_renderer(native_ptr)
        let rv = Gsk.RendererRef(gconstpointer: gconstpointer(result))
...
public extension NamedActionProtocol {
    ...
    @inlinable func getActionName() -> String! {
        let result = gtk_named_action_get_action_name(named_action_ptr)
...
public extension NativeDialogProtocol {
    ...
    @discardableResult @inlinable func onResponse(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NativeDialogRef, _ responseId: Int) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NativeDialogRef, Int), Void>
    ...
    @discardableResult @inlinable func onNotifyModal(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NativeDialogRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NativeDialogRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NativeDialogRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
            return output
        }
        return connect(
            signal: .notifyModal,
    ...
    @discardableResult @inlinable func onNotifyTitle(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NativeDialogRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NativeDialogRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NativeDialogRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyTransientFor(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NativeDialogRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NativeDialogRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NativeDialogRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyVisible(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NativeDialogRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NativeDialogRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NativeDialogRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
...
public extension NativeDialogProtocol {
    ...
    @inlinable func getModal() -> Bool {
        let result = gtk_native_dialog_get_modal(native_dialog_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getTitle() -> String! {
        let result = gtk_native_dialog_get_title(native_dialog_ptr)
        let rv = result.map({ String(cString: $0) })
        return rv
    }
    ...
    @inlinable func getTransientFor() -> WindowRef! {
        let result = gtk_native_dialog_get_transient_for(native_dialog_ptr)
    ...
    @inlinable func getVisible() -> Bool {
        let result = gtk_native_dialog_get_visible(native_dialog_ptr)
        let rv = ((result) != 0)
        return rv
    }
...
public extension NoSelectionRef {
    ...
    @inlinable init<GioListModelT: GIO.ListModelProtocol>( model: GioListModelT?) {
            let result = gtk_no_selection_new(model?.list_model_ptr)
        let rv = result
...
public extension NoSelectionProtocol {
    ...
    @inlinable func getModel() -> GIO.ListModelRef! {
        let result = gtk_no_selection_get_model(no_selection_ptr)
...
public extension NotebookProtocol {
    ...
    @discardableResult @inlinable func onChangeCurrentPage(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ object: Int) -> Bool ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, Int), Bool>
    ...
    @discardableResult @inlinable func onFocusTab(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ object: NotebookTab) -> Bool ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, NotebookTab), Bool>
    ...
    @discardableResult @inlinable func onMoveFocusOut(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ object: DirectionType) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, DirectionType), Void>
    ...
    @discardableResult @inlinable func onPageAdded(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ child: WidgetRef, _ pageNum: UInt) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, WidgetRef, UInt), Void>
    ...
    @discardableResult @inlinable func onReorderTab(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ object: DirectionType, _ p0: Bool) -> Bool ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, DirectionType, Bool), Bool>
    ...
    @discardableResult @inlinable func onSelectPage(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ object: Bool) -> Bool ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, Bool), Bool>
    ...
    @discardableResult @inlinable func onNotifyEnablePopup(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NotebookRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
            return output
        }
        return connect(
    ...
    @discardableResult @inlinable func onNotifyGroupName(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NotebookRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyPage(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NotebookRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyPages(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NotebookRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyScrollable(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NotebookRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyShowBorder(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NotebookRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyShowTabs(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NotebookRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyTabPos(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NotebookRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(NotebookRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((NotebookRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
...
public extension NotebookProtocol {
    ...
    @inlinable func appendPage<WidgetT: WidgetProtocol>(child: WidgetT, tabLabel: WidgetT?) -> Int {
        let result = gtk_notebook_append_page(notebook_ptr, child.widget_ptr, tabLabel?.widget_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func appendPageMenu<WidgetT: WidgetProtocol>(child: WidgetT, tabLabel: WidgetT?, menuLabel: WidgetT?) -> Int {
        let result = gtk_notebook_append_page_menu(notebook_ptr, child.widget_ptr, tabLabel?.widget_ptr, menuLabel?.widget_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func getActionWidget(packType: GtkPackType) -> WidgetRef! {
        let result = gtk_notebook_get_action_widget(notebook_ptr, packType)
    ...
    @inlinable func getCurrentPage() -> Int {
        let result = gtk_notebook_get_current_page(notebook_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func getGroupName() -> String! {
        let result = gtk_notebook_get_group_name(notebook_ptr)
        let rv = result.map({ String(cString: $0) })
        return rv
    }
    ...
    @inlinable func getMenuLabel<WidgetT: WidgetProtocol>(child: WidgetT) -> WidgetRef! {
        let result = gtk_notebook_get_menu_label(notebook_ptr, child.widget_ptr)
        guard let rv = WidgetRef(gconstpointer: gconstpointer(result)) else { return nil }
        return rv
    }
    ...
    @inlinable func getMenuLabelText<WidgetT: WidgetProtocol>(child: WidgetT) -> String! {
        let result = gtk_notebook_get_menu_label_text(notebook_ptr, child.widget_ptr)
        let rv = result.map({ String(cString: $0) })
        return rv
    }
    ...
    @inlinable func getNPages() -> Int {
        let result = gtk_notebook_get_n_pages(notebook_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func getNthPage(pageNum: Int) -> WidgetRef! {
        let result = gtk_notebook_get_nth_page(notebook_ptr, gint(pageNum))
        guard let rv = WidgetRef(gconstpointer: gconstpointer(result)) else { return nil }
        return rv
    }
    ...
    @inlinable func getPage<WidgetT: WidgetProtocol>(child: WidgetT) -> NotebookPageRef! {
        let result = gtk_notebook_get_page(notebook_ptr, child.widget_ptr)
        let rv = NotebookPageRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func getPages() -> GIO.ListModelRef! {
        let result = gtk_notebook_get_pages(notebook_ptr)
        let rv = GIO.ListModelRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func getScrollable() -> Bool {
        let result = gtk_notebook_get_scrollable(notebook_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getShowBorder() -> Bool {
        let result = gtk_notebook_get_show_border(notebook_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getShowTabs() -> Bool {
        let result = gtk_notebook_get_show_tabs(notebook_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getTabDetachable<WidgetT: WidgetProtocol>(child: WidgetT) -> Bool {
        let result = gtk_notebook_get_tab_detachable(notebook_ptr, child.widget_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getTabLabel<WidgetT: WidgetProtocol>(child: WidgetT) -> WidgetRef! {
        let result = gtk_notebook_get_tab_label(notebook_ptr, child.widget_ptr)
        guard let rv = WidgetRef(gconstpointer: gconstpointer(result)) else { return nil }
        return rv
    }
    ...
    @inlinable func getTabLabelText<WidgetT: WidgetProtocol>(child: WidgetT) -> String! {
        let result = gtk_notebook_get_tab_label_text(notebook_ptr, child.widget_ptr)
        let rv = result.map({ String(cString: $0) })
        return rv
    }
    ...
    @inlinable func getTabPos() -> GtkPositionType {
        let result = gtk_notebook_get_tab_pos(notebook_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getTabReorderable<WidgetT: WidgetProtocol>(child: WidgetT) -> Bool {
        let result = gtk_notebook_get_tab_reorderable(notebook_ptr, child.widget_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func insertPage<WidgetT: WidgetProtocol>(child: WidgetT, tabLabel: WidgetT?, position: Int) -> Int {
        let result = gtk_notebook_insert_page(notebook_ptr, child.widget_ptr, tabLabel?.widget_ptr, gint(position))
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func insertPageMenu<WidgetT: WidgetProtocol>(child: WidgetT, tabLabel: WidgetT?, menuLabel: WidgetT?, position: Int) -> Int {
        let result = gtk_notebook_insert_page_menu(notebook_ptr, child.widget_ptr, tabLabel?.widget_ptr, menuLabel?.widget_ptr, gint(position))
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func pageNum<WidgetT: WidgetProtocol>(child: WidgetT) -> Int {
        let result = gtk_notebook_page_num(notebook_ptr, child.widget_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func prependPage<WidgetT: WidgetProtocol>(child: WidgetT, tabLabel: WidgetT?) -> Int {
        let result = gtk_notebook_prepend_page(notebook_ptr, child.widget_ptr, tabLabel?.widget_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func prependPageMenu<WidgetT: WidgetProtocol>(child: WidgetT, tabLabel: WidgetT?, menuLabel: WidgetT?) -> Int {
        let result = gtk_notebook_prepend_page_menu(notebook_ptr, child.widget_ptr, tabLabel?.widget_ptr, menuLabel?.widget_ptr)
        let rv = Int(result)
        return rv
    }
...
public extension NotebookPageProtocol {
    ...
    @inlinable func getChild() -> WidgetRef! {
        let result = gtk_notebook_page_get_child(notebook_page_ptr)
...
public extension NumericSorterRef {
    ...
    @inlinable init<ExpressionT: ExpressionProtocol>( expression: ExpressionT?) {
            let result = gtk_numeric_sorter_new(expression?.expression_ptr)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
}
...
public extension NumericSorterProtocol {
    ...
    @inlinable func getExpression() -> ExpressionRef! {
        let result = gtk_numeric_sorter_get_expression(numeric_sorter_ptr)
    ...
    @inlinable func getSortOrder() -> GtkSortType {
        let result = gtk_numeric_sorter_get_sort_order(numeric_sorter_ptr)
        let rv = result
        return rv
    }
