...
public extension LabelRef {
    ...
    @inlinable init(mnemonic str: UnsafePointer<CChar>? = nil) {
            let result = gtk_label_new_with_mnemonic(str)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
    /// Creates a new `GtkLabel`, containing the text in `str`.
...
public enum LabelPropertyName: String, PropertyNameProtocol {
    ...
    case naturalWrapMode = "natural-wrap-mode"
...
public enum LabelSignalName: String, SignalNameProtocol {
    ...
    /// The default is `GTK_NATURAL_WRAP_INHERIT`, which inherits the behavior of the
    /// [property`Gtk.Label:wrap-mode`] property.
    case notifyNaturalWrapMode = "notify::natural-wrap-mode"
    /// The requested opacity of the widget.
...
public extension LabelProtocol {
    ...
    @discardableResult @inlinable func onActivateLink(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ uri: String) -> Bool ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, String), Bool>
    ...
    @discardableResult @inlinable func onMoveCursor(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ step: MovementStep, _ count: Int, _ extendSelection: Bool) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, MovementStep, Int, Bool), Void>
    ...
    @discardableResult @inlinable func onNotifyAttributes(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
            return output
        }
        return connect(
    ...
    @discardableResult @inlinable func onNotifyEllipsize(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyExtraMenu(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyJustify(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyLabel(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyLines(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyMaxWidthChars(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyMnemonicKeyval(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyMnemonicWidget(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    /// [canonical parameter names](#canonical-parameter-names) as
    /// detail strings for the notify signal.
    /// - Note: This represents the underlying `notify::natural-wrap-mode` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter pspec: the `GParamSpec` of the property which changed.
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `notifyNaturalWrapMode` signal is emitted
    @discardableResult @inlinable func onNotifyNaturalWrapMode(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    /// Typed `notify::natural-wrap-mode` signal for using the `connect(signal:)` methods
    static var notifyNaturalWrapModeSignal: LabelSignalName { .notifyNaturalWrapMode }
    ...
    @discardableResult @inlinable func onNotifySelectable(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifySingleLineMode(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyTabs(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    static var notifyTabsSignal: LabelSignalName { .notifyTabs }
    ...
    @discardableResult @inlinable func onNotifyUseMarkup(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyUseUnderline(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyWidthChars(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyWrap(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyWrapMode(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyXalign(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyYalign(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LabelRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LabelRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LabelRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
...
public extension LabelProtocol {
    ...
    @inlinable func getAttributes() -> Pango.AttrListRef! {
        let result = gtk_label_get_attributes(label_ptr)
    ...
    @inlinable func getCurrentUri() -> String! {
        let result = gtk_label_get_current_uri(label_ptr)
    ...
    @inlinable func getEllipsize() -> PangoEllipsizeMode {
        let result = gtk_label_get_ellipsize(label_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getExtraMenu() -> GIO.MenuModelRef! {
        let result = gtk_label_get_extra_menu(label_ptr)
    ...
    @inlinable func getJustify() -> GtkJustification {
        let result = gtk_label_get_justify(label_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getLabel() -> String! {
        let result = gtk_label_get_label(label_ptr)
        let rv = result.map({ String(cString: $0) })
        return rv
    }
    ...
    @inlinable func getLayout() -> Pango.LayoutRef! {
        let result = gtk_label_get_layout(label_ptr)
    ...
    @inlinable func getLines() -> Int {
        let result = gtk_label_get_lines(label_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func getMaxWidthChars() -> Int {
        let result = gtk_label_get_max_width_chars(label_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func getMnemonicKeyval() -> Int {
        let result = gtk_label_get_mnemonic_keyval(label_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func getMnemonicWidget() -> WidgetRef! {
        let result = gtk_label_get_mnemonic_widget(label_ptr)
        guard let rv = WidgetRef(gconstpointer: gconstpointer(result)) else { return nil }
        return rv
    }
    ...
    @inlinable func getNaturalWrapMode() -> GtkNaturalWrapMode {
        let result = gtk_label_get_natural_wrap_mode(label_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getSelectable() -> Bool {
        let result = gtk_label_get_selectable(label_ptr)
        let rv = ((result) != 0)
        return rv
    }

    /// Gets the selected range of characters in the label.
    @inlinable func getSelectionBounds(start: UnsafeMutablePointer<gint>! = nil, end: UnsafeMutablePointer<gint>! = nil) -> Bool {
        let result = gtk_label_get_selection_bounds(label_ptr, start, end)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getSingleLineMode() -> Bool {
        let result = gtk_label_get_single_line_mode(label_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getTabs() -> Pango.TabArrayRef! {
        let result = gtk_label_get_tabs(label_ptr)
    ...
    @inlinable func getText() -> String! {
        let result = gtk_label_get_text(label_ptr)
        let rv = result.map({ String(cString: $0) })
        return rv
    }
    ...
    @inlinable func getUseMarkup() -> Bool {
        let result = gtk_label_get_use_markup(label_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getUseUnderline() -> Bool {
        let result = gtk_label_get_use_underline(label_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getWidthChars() -> Int {
        let result = gtk_label_get_width_chars(label_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func getWrap() -> Bool {
        let result = gtk_label_get_wrap(label_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getWrapMode() -> PangoWrapMode {
        let result = gtk_label_get_wrap_mode(label_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getXalign() -> CFloat {
        let result = gtk_label_get_xalign(label_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getYalign() -> CFloat {
        let result = gtk_label_get_yalign(label_ptr)
        let rv = result
        return rv
    }
    ...
    /// This only affects the natural size requested, for the actual wrapping used,
    /// see the [property`Gtk.Label:wrap-mode`] property.
    @inlinable func setNatural(wrapMode: GtkNaturalWrapMode) {
        
        gtk_label_set_natural_wrap_mode(label_ptr, wrapMode)
    ...
    @inlinable func set(tabs: Pango.TabArrayRef? = nil) {
        ...
        gtk_label_set_tabs(label_ptr, tabs?.tab_array_ptr)
    ...
    /// 
    /// See [method`Gtk.Label.set_natural_wrap_mode`].
    @inlinable var naturalWrapMode: GtkNaturalWrapMode {
        /// Returns line wrap mode used by the label.
        /// 
        /// See [method`Gtk.Label.set_natural_wrap_mode`].
        get {
        ...
        /// see the [property`Gtk.Label:wrap-mode`] property.
        nonmutating set {
            gtk_label_set_natural_wrap_mode(label_ptr, newValue)
        }
    }
    ...
    @inlinable var tabs: Pango.TabArrayRef! {
        ...
        /// Sets the default tab stops for paragraphs in `self`.
        nonmutating set {
            gtk_label_set_tabs(label_ptr, UnsafeMutablePointer<PangoTabArray>(newValue?.tab_array_ptr))
        }
    }
...
public extension LayoutChildProtocol {
    ...
    @inlinable func getChildWidget() -> WidgetRef! {
        let result = gtk_layout_child_get_child_widget(layout_child_ptr)
    ...
    @inlinable func getLayoutManager() -> LayoutManagerRef! {
        let result = gtk_layout_child_get_layout_manager(layout_child_ptr)
...
public extension LayoutManagerProtocol {
    ...
    @inlinable func getLayout<WidgetT: WidgetProtocol>(child: WidgetT) -> LayoutChildRef! {
        let result = gtk_layout_manager_get_layout_child(layout_manager_ptr, child.widget_ptr)
        let rv = LayoutChildRef(gconstpointer: gconstpointer(result))
        return rv
    }

    /// Retrieves the request mode of `manager`.
    @inlinable func getRequestMode() -> GtkSizeRequestMode {
        let result = gtk_layout_manager_get_request_mode(layout_manager_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getWidget() -> WidgetRef! {
        let result = gtk_layout_manager_get_widget(layout_manager_ptr)
        let rv = WidgetRef(gconstpointer: gconstpointer(result))
        return rv
    }
...
public extension LevelBarRef {
    ...
    @inlinable init(interval minValue: CDouble, maxValue: CDouble) {
            let result = gtk_level_bar_new_for_interval(minValue, maxValue)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
    /// Creates a new `GtkLevelBar` for the specified interval.
...
public extension LevelBarProtocol {
    ...
    @discardableResult @inlinable func onOffsetChanged(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LevelBarRef, _ name: String) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LevelBarRef, String), Void>
    ...
    @discardableResult @inlinable func onNotifyInverted(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LevelBarRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LevelBarRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LevelBarRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
            return output
        }
        return connect(
    ...
    @discardableResult @inlinable func onNotifyMaxValue(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LevelBarRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LevelBarRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LevelBarRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyMinValue(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LevelBarRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LevelBarRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LevelBarRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyMode(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LevelBarRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LevelBarRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LevelBarRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyValue(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LevelBarRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LevelBarRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LevelBarRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
...
public extension LevelBarProtocol {
    ...
    @inlinable func getInverted() -> Bool {
        let result = gtk_level_bar_get_inverted(level_bar_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getMaxValue() -> CDouble {
        let result = gtk_level_bar_get_max_value(level_bar_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getMinValue() -> CDouble {
        let result = gtk_level_bar_get_min_value(level_bar_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getMode() -> GtkLevelBarMode {
        let result = gtk_level_bar_get_mode(level_bar_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getOffsetValue(name: UnsafePointer<CChar>? = nil, value: UnsafeMutablePointer<CDouble>!) -> Bool {
        let result = gtk_level_bar_get_offset_value(level_bar_ptr, name, value)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getValue() -> CDouble {
        let result = gtk_level_bar_get_value(level_bar_ptr)
        let rv = result
        return rv
    }
...
public extension LinkButtonRef {
    ...
    @inlinable init( uri: UnsafePointer<CChar>!) {
            let result = gtk_link_button_new(uri)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
    ...
    @inlinable init(label uri: UnsafePointer<CChar>!, label: UnsafePointer<CChar>? = nil) {
            let result = gtk_link_button_new_with_label(uri, label)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
    /// Creates a new `GtkLinkButton` containing a label.
...
public extension LinkButtonProtocol {
    ...
    @discardableResult @inlinable func onNotifyUri(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LinkButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LinkButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LinkButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
            return output
        }
        return connect(
            signal: .notifyUri,
    ...
    @discardableResult @inlinable func onNotifyVisited(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: LinkButtonRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(LinkButtonRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((LinkButtonRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
...
public extension LinkButtonProtocol {
    ...
    @inlinable func getUri() -> String! {
        let result = gtk_link_button_get_uri(link_button_ptr)
        let rv = result.map({ String(cString: $0) })
        return rv
    }
    ...
    @inlinable func getVisited() -> Bool {
        let result = gtk_link_button_get_visited(link_button_ptr)
        let rv = ((result) != 0)
        return rv
    }
...
public extension ListBoxProtocol {
    ...
    @discardableResult @inlinable func onMoveCursor(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListBoxRef, _ object: MovementStep, _ p0: Int, _ p1: Bool, _ p2: Bool) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListBoxRef, MovementStep, Int, Bool, Bool), Void>
    ...
    @discardableResult @inlinable func onRowActivated(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListBoxRef, _ row: ListBoxRowRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListBoxRef, ListBoxRowRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
    ...
    @discardableResult @inlinable func onNotifyAcceptUnpairedRelease(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListBoxRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListBoxRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListBoxRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
            return output
        }
        return connect(
    ...
    @discardableResult @inlinable func onNotifyActivateOnSingleClick(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListBoxRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListBoxRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListBoxRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifySelectionMode(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListBoxRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListBoxRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListBoxRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyShowSeparators(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListBoxRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListBoxRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListBoxRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
...
public extension ListBoxProtocol {
    ...
    /// functionality in `GtkListBox`. When using a model, filtering and sorting
    /// should be implemented by the model.
    @inlinable func bind<GioListModelT: GIO.ListModelProtocol>(model: GioListModelT?, createWidgetFunc: GtkListBoxCreateWidgetFunc? = nil, userData: gpointer? = nil, userDataFreeFunc: GDestroyNotify?) {
    ...
    @inlinable func getActivateOnSingleClick() -> Bool {
        let result = gtk_list_box_get_activate_on_single_click(list_box_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getAdjustment() -> AdjustmentRef! {
        let result = gtk_list_box_get_adjustment(list_box_ptr)
    ...
    @inlinable func getRowAt(index: Int) -> ListBoxRowRef! {
        let result = gtk_list_box_get_row_at_index(list_box_ptr, gint(index))
        let rv = ListBoxRowRef(gconstpointer: gconstpointer(result))
        return rv
    }

    /// Gets the row at the `y` position.
    @inlinable func getRowAt(y: Int) -> ListBoxRowRef! {
        let result = gtk_list_box_get_row_at_y(list_box_ptr, gint(y))
        let rv = ListBoxRowRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func getSelectedRow() -> ListBoxRowRef! {
        let result = gtk_list_box_get_selected_row(list_box_ptr)
        let rv = ListBoxRowRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func getSelectedRows() -> GLib.ListRef! {
        let result = gtk_list_box_get_selected_rows(list_box_ptr)
    ...
    @inlinable func getSelectionMode() -> GtkSelectionMode {
        let result = gtk_list_box_get_selection_mode(list_box_ptr)
        let rv = result
        return rv
    }
    ...
    @inlinable func getShowSeparators() -> Bool {
        let result = gtk_list_box_get_show_separators(list_box_ptr)
        let rv = ((result) != 0)
        return rv
    }
...
public extension ListBoxRowRef {
    ...
    @inlinable init() {
            let result = gtk_list_box_row_new()
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
}
...
public extension ListBoxRowProtocol {
    ...
    @discardableResult @inlinable func onNotifyActivatable(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListBoxRowRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListBoxRowRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListBoxRowRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
            return output
        }
        return connect(
    ...
    @discardableResult @inlinable func onNotifyChild(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListBoxRowRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListBoxRowRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListBoxRowRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `notifySelectable` signal is emitted
    @discardableResult @inlinable func onNotifySelectable(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListBoxRowRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListBoxRowRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListBoxRowRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
...
public extension ListBoxRowProtocol {
    ...
    @inlinable func getActivatable() -> Bool {
        let result = gtk_list_box_row_get_activatable(list_box_row_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getChild() -> WidgetRef! {
        let result = gtk_list_box_row_get_child(list_box_row_ptr)
        guard let rv = WidgetRef(gconstpointer: gconstpointer(result)) else { return nil }
        return rv
    }
    ...
    @inlinable func getHeader() -> WidgetRef! {
        let result = gtk_list_box_row_get_header(list_box_row_ptr)
        guard let rv = WidgetRef(gconstpointer: gconstpointer(result)) else { return nil }
        return rv
    }
    ...
    @inlinable func getIndex() -> Int {
        let result = gtk_list_box_row_get_index(list_box_row_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func getSelectable() -> Bool {
        let result = gtk_list_box_row_get_selectable(list_box_row_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable var isSelected: Bool {
        ...
        /// `GtkListBox` container.
        get {
            let result = gtk_list_box_row_is_selected(list_box_row_ptr)
        let rv = ((result) != 0)
            return rv
        }
    }
...
public extension ListItemProtocol {
    ...
    @inlinable func getActivatable() -> Bool {
        let result = gtk_list_item_get_activatable(list_item_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    /// `nil` if none was set.
    @inlinable func getChild() -> WidgetRef! {
        let result = gtk_list_item_get_child(list_item_ptr)
        let rv = WidgetRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    @inlinable func getItem() -> GLibObject.ObjectRef! {
        let result = gtk_list_item_get_item(list_item_ptr)
    ...
    @inlinable func getPosition() -> Int {
        let result = gtk_list_item_get_position(list_item_ptr)
        let rv = Int(result)
        return rv
    }
    ...
    @inlinable func getSelectable() -> Bool {
        let result = gtk_list_item_get_selectable(list_item_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getSelected() -> Bool {
        let result = gtk_list_item_get_selected(list_item_ptr)
        let rv = ((result) != 0)
        return rv
    }
...
public extension ListStoreRef {
    ...
    @inlinable init(nColumns: Int, types: UnsafeMutablePointer<GType>!) {
            let result = gtk_list_store_newv(gint(nColumns), types)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
    /// Non-vararg creation function.  Used primarily by language bindings.
    @inlinable static func listStoreNewv(nColumns: Int, types: UnsafeMutablePointer<GType>!) -> ListStoreRef! {
            let result = gtk_list_store_newv(gint(nColumns), types)
        guard let rv = ListStoreRef(gconstpointer: gconstpointer(result)) else { return nil }
        return rv
    }
}
...
open class ListStore: GLibObject.Object, ListStoreProtocol {
    ...
    @inlinable public static func listStoreNewv(nColumns: Int, types: UnsafeMutablePointer<GType>!) -> ListStore! {
            let result = gtk_list_store_newv(gint(nColumns), types)
        guard let rv = ListStore(gconstpointer: gconstpointer(result)) else { return nil }
            if typeIsA(type: rv.type, isAType: InitiallyUnownedClassRef.metatypeReference) { _ = rv.refSink() } 
return rv
    }
...
public extension ListStoreProtocol {
    ...
    @inlinable func iterIsValid<TreeIterT: TreeIterProtocol>(iter: TreeIterT) -> Bool {
        let result = gtk_list_store_iter_is_valid(list_store_ptr, iter.tree_iter_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func remove<TreeIterT: TreeIterProtocol>(iter: TreeIterT) -> Bool {
        let result = gtk_list_store_remove(list_store_ptr, iter.tree_iter_ptr)
        let rv = ((result) != 0)
        return rv
    }
...
public extension ListViewRef {
    ...
    @inlinable init<ListItemFactoryT: ListItemFactoryProtocol, SelectionModelT: SelectionModelProtocol>( model: SelectionModelT?, factory: ListItemFactoryT?) {
            let result = gtk_list_view_new(model?.selection_model_ptr, factory?.list_item_factory_ptr)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
}
...
public extension ListViewProtocol {
    ...
    @discardableResult @inlinable func onActivate(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListViewRef, _ position: UInt) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListViewRef, UInt), Void>
    ...
    @discardableResult @inlinable func onNotifyEnableRubberband(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListViewRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListViewRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListViewRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
            return output
        }
        return connect(
    ...
    @discardableResult @inlinable func onNotifyFactory(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListViewRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListViewRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListViewRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifyModel(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListViewRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListViewRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListViewRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `notifyShowSeparators` signal is emitted
    @discardableResult @inlinable func onNotifyShowSeparators(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListViewRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListViewRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListViewRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
    ...
    @discardableResult @inlinable func onNotifySingleClickActivate(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ListViewRef, _ pspec: GLibObject.ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ListViewRef, GLibObject.ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ListViewRef(raw: unownedSelf), GLibObject.ParamSpecRef(raw: arg1)))
...
public extension ListViewProtocol {
    ...
    @inlinable func getEnableRubberband() -> Bool {
        let result = gtk_list_view_get_enable_rubberband(list_view_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getFactory() -> ListItemFactoryRef! {
        let result = gtk_list_view_get_factory(list_view_ptr)
    ...
    @inlinable func getModel() -> SelectionModelRef! {
        let result = gtk_list_view_get_model(list_view_ptr)
    ...
    /// between rows.
    @inlinable func getShowSeparators() -> Bool {
        let result = gtk_list_view_get_show_separators(list_view_ptr)
        let rv = ((result) != 0)
        return rv
    }
    ...
    @inlinable func getSingleClickActivate() -> Bool {
        let result = gtk_list_view_get_single_click_activate(list_view_ptr)
        let rv = ((result) != 0)
        return rv
    }
...
public extension LockButtonRef {
    ...
    @inlinable init<GioPermissionT: GIO.PermissionProtocol>( permission: GioPermissionT?) {
            let result = gtk_lock_button_new(permission?.permission_ptr)
        let rv = result
            ptr = UnsafeMutableRawPointer(rv)
    }
}
...
open class LockButton: Button, LockButtonProtocol {
    ...
    /// Creates a new lock button which reflects the `permission`.
    @inlinable public init<GioPermissionT: GIO.PermissionProtocol>( permission: GioPermissionT?) {
            let result = gtk_lock_button_new(permission?.permission_ptr)
        let rv = result
            super.init(gpointer: gpointer(rv))
    if typeIsA(type: self.type, isAType: InitiallyUnownedClassRef.metatypeReference) { _ = self.refSink() } 
...
public extension LockButtonProtocol {
    ...
    @inlinable func getPermission() -> GIO.PermissionRef! {
        let result = gtk_lock_button_get_permission(lock_button_ptr)
        let rv = GIO.PermissionRef(gconstpointer: gconstpointer(result))
        return rv
    }
    ...
    /// Sets the `GPermission` object that controls `button`.
    @inlinable func set<GioPermissionT: GIO.PermissionProtocol>(permission: GioPermissionT?) {
